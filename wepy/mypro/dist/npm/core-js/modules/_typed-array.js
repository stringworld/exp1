...
if(require('./_descriptors.js')){
  var LIBRARY             = require('./_library.js')
    ...
    , uid                 = require('./_uid.js')
    , wks                 = require('./_wks.js')
    , createArrayMethod   = require('./_array-methods.js')
    , createArrayIncludes = require('./_array-includes.js')
    , speciesConstructor  = require('./_species-constructor.js')
    , ArrayIterators      = require('./es6.array.iterator.js')
    , Iterators           = require('./_iterators.js')
    , $iterDetect         = require('./_iter-detect.js')
    , setSpecies          = require('./_set-species.js')
    , arrayFill           = require('./_array-fill.js')
    , arrayCopyWithin     = require('./_array-copy-within.js')
