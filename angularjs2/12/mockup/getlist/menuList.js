...
var data = function() {
    return Mock.mock([{
            ...
            menuText: '任务管理',
            level: [{ levelTxt: '任务分配', levelRoute: 'main.task' }, { levelTxt: '所有任务', levelRoute: 'main.alltask' }, { levelTxt: '我的任务', levelRoute: 'main.mytask' }],
            roteUrl: 'main.page3',
            isShow: true
        }, {
            img: 'http://7xso1h.com1.z0.glb.clouddn.com/menu-fuwu.png',
            menuText: '录音管理',
            level: [{ levelTxt: '所有录音', levelRoute: 'main.page3' }, { levelTxt: '我的录音', levelRoute: 'main.page3' }],
            roteUrl: 'main.page4',
            isShow: true
        }, {
            img: 'http://7xso1h.com1.z0.glb.clouddn.com/menu-task.png',
            menuText: '坐席管理',
            level: [{ levelTxt: '状态监控', levelRoute: 'main.page3' }, { levelTxt: '所有回访结果', levelRoute: 'main.page3' }, { levelTxt: '我的回访结果', levelRoute: 'main.page3' }, { levelTxt: '服务统计', levelRoute: 'main.page3' }],
            roteUrl: 'main.page4',
            isShow: true
        }, {
            ...
            menuText: '系统设置',
            level: [{ levelTxt: '帐号管理', levelRoute: 'main.page3' }, { levelTxt: '角色管理', levelRoute: 'main.page3' }, { levelTxt: '系统参数', levelRoute: 'main.page3' }],
            roteUrl: 'main.page4',
            isShow: true
        }
        // , {
